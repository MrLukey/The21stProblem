...
app.post('/sign-ups', verifyAdmin, ...validateSignUpRequest, getSignUps)
app.post('/messages', verifyAdmin, ...validateMessageRequest, getMessages)
app.post('/site-activity', verifyAdmin, ...validateSiteActivityRequest, getSiteActivity)
app.post('/suspicious-activity', verifyAdmin, ...validateSuspiciousActivityRequest, getSuspiciousActivity)
app.post('/edit-message-state', verifyAdmin, ...validateMessageEdit, editMessageState)
app.post('/edit-sign-up-state', verifyAdmin, ...validateSignUpEdit, editSignUpState)
